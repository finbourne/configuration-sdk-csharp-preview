...
namespace Finbourne.Configuration.Sdk.Model
{
    ...
    public partial class ConfigurationItemSummary : IEquatable<ConfigurationItemSummary>
    {
        ...
        /// <param name="isSecret">Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class. (required).</param>
        public ConfigurationItemSummary(string key = default(string), string value = default(string), string valueType = default(string), bool isSecret = default(bool))
        {
        ...
        /// <summary>
        /// Defines how the value is presented.  If it is secret, the value will be hidden.  If it is text, the value will be in plain-text.
        /// </summary>
        /// <value>Defines how the value is presented.  If it is secret, the value will be hidden.  If it is text, the value will be in plain-text.</value>
