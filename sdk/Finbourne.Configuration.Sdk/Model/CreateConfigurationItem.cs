...
namespace Finbourne.Configuration.Sdk.Model
{
    ...
    public partial class CreateConfigurationItem : IEquatable<CreateConfigurationItem>
    {
        ...
        /// <param name="valueType">The type of the new configuration item&#39;s value.</param>
        /// <param name="type">The type (text or secret) of the new configuration item.</param>
        /// <param name="isSecret">Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class..</param>
        /// <param name="description">The description of the new configuration item.</param>
        public CreateConfigurationItem(string key = default(string), string value = default(string), string valueType = default(string), string type = default(string), bool? isSecret = default(bool?), string description = default(string))
        {
        ...
        /// <summary>
        /// The type of the new configuration item&#39;s value
        /// </summary>
        /// <value>The type of the new configuration item&#39;s value</value>
        [DataMember(Name = "valueType", EmitDefaultValue = true)]
        public string ValueType { get; set; }

        /// <summary>
        /// The type (text or secret) of the new configuration item
        /// </summary>
        /// <value>The type (text or secret) of the new configuration item</value>
        [DataMember(Name = "type", EmitDefaultValue = true)]
        public string Type { get; set; }

        /// <summary>
        /// Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class.
        /// </summary>
        /// <value>Defines whether or not the value is a secret.  This field will eventually replace the Type field of this class.</value>
